import 'package:iccm_yemen/ui/helpers/helpers.dart';
...
import 'package:iccm_yemen/presentation/presenters/presenters.dart';
import 'package:iccm_yemen/presentation/protocols/protocols.dart';
...
void main() {
  ...
  test('Should change page on success', () async {
    ...
    sut.navigateToStream.listen(expectAsync1((page) => expect(page, '/chv_malaria_cases_list')));
