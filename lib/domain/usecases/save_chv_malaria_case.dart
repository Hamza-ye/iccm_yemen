...
abstract class SaveChvMalariaCase {
  Future<ChvMalariaCaseEntity> save(SaveChvMalariaCaseParams params);
}

class SaveChvMalariaCaseParams extends Equatable {
  final int? id;
  final String? uid;
  final String? code;
  final String? uuid;
  ...
  const SaveChvMalariaCaseParams(
      {this.id,
        this.uid,
        this.code,
        this.uuid,
