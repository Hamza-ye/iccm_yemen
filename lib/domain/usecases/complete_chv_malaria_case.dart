...
abstract class CompleteChvMalariaCase {
  Future<ChvMalariaCaseEntity> complete(CompleteChvMalariaCaseParams params);
}

class CompleteChvMalariaCaseParams extends Equatable {
  final int? id;
  final String? uid;
  final String? code;
  final String? uuid;
  ...
  const CompleteChvMalariaCaseParams(
      {this.id,
      this.uid,
      this.code,
      this.uuid,
