...
abstract class SyncChvMalariaCase {
  Future<ChvMalariaCaseEntity> save(SyncChvMalariaCaseParams params);
}

class SyncChvMalariaCaseParams extends Equatable {
  final int? id;
  final String? uid;
  final String? code;
  final String? uuid;
  ...
  const SyncChvMalariaCaseParams(
      {this.id,
        this.uid,
        this.code,
        this.uuid,
